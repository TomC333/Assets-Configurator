import { DEFAULT_CACHE_PREFIX, DEFAULT_CACHE_SUFFIX } from "./globals";
...
export class Extenstions{
    ...
    */
    static generateCacheName(cacheName: string): string{
        return DEFAULT_CACHE_PREFIX + cacheName + DEFAULT_CACHE_SUFFIX;
    }
    ...
    */
    static cacheNameToProfileName(cacheName: string): string {
        let profileName = cacheName.replace(new RegExp(`^${DEFAULT_CACHE_PREFIX}`, 'i'), '');
        profileName = profileName.replace(new RegExp(`${DEFAULT_CACHE_SUFFIX}$`, 'i'), '');
    ...
    */
    static profileNameToCacheName(profileName: string): string {
        return DEFAULT_CACHE_PREFIX + profileName + DEFAULT_CACHE_SUFFIX;
    }
}
